    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> SummaryPost(string stripeEmail, string stripeToken)
        {
            ...
            if (charge.Status.ToLower() == "succeeded")
            {
                ...
                await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email, "Spice - Order Created " + detailCart.OrderHeader.Id.ToString(), "We have received your order. Thank you!");
