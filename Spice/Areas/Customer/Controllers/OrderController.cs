...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Ready " + orderHeader.Id.ToString(), "Your order is ready for pickup. Thank you!");
            return RedirectToAction("ManageOrder", "Order");
        }
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Cancelled " + orderHeader.Id.ToString(), "Your order has been successfully cancelled.");
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Spice - Order Completed " + orderHeader.Id.ToString(), "Your order has been successfully completed.");
